...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Fmd/BookingManagementBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Fmd/PersonneBundle/Entity')));

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($b, 'Fmd\\BookingManagementBundle\\Entity');
$c->addDriver($b, 'Fmd\\PersonneBundle\\Entity');

$d = new \Doctrine\ORM\Configuration();
$d->setEntityNamespaces(array('FmdBookingManagementBundle' => 'Fmd\\BookingManagementBundle\\Entity', 'FmdPersonneBundle' => 'Fmd\\PersonneBundle\\Entity'));
